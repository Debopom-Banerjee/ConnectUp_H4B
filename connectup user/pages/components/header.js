  ...
  return (
    ...
    >
      <div className={style.main}>
        ...
        <h1 className={style.tindText}>ConnectUp</h1>

        <div className={style.leftMenu}>
        <div className={style.menuItem}>Resources</div>
          <div className={style.menuItem}>SignUp as a teacher</div>
          <div className={style.menuItem}>SignUp as a student</div>
          <div className={style.menuItem}>xyz</div>
        </div>
      </div>
